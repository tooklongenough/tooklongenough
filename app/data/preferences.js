export const preferences = {
  movies: [
    ...
    { name: 'Garden State', preference: 'couple', description: 'A quirky romantic comedy about returning home and self-discovery.' },
    ...
    { name: "What's Eating Gilbert Grape", preference: 'couple', description: 'A heartfelt drama about family, love, and small-town life.' },
    ...
    { name: "Eve's Bayou", preference: 'couple', description: 'A Southern Gothic tale of family secrets and magic.' },
    ...
    { name: 'Mary Poppins', preference: 'couple', description: 'A magical musical about a whimsical nanny in London.' },
    { name: 'Sound of Music', preference: 'couple', description: 'A beloved musical about family, music, and resilience.' },
    { name: 'Harry Potter movies', preference: 'couple', description: 'A magical saga following young wizards at Hogwarts.' },
  ...
  shows: [
    ...
    { name: 'Adolescence', preference: 'couple', description: 'A coming-of-age series exploring youth and transformation.' },
    { name: 'Bad Sisters', preference: 'couple', description: 'A dark comedy about sisters and a suspicious death.' },
    ...
    { name: 'American Horror Story', preference: 'couple', description: 'An anthology series of twisted, terrifying tales.' },
    { name: 'Bates Motel', preference: 'couple', description: 'A psychological thriller prequel to Psycho.' },
    { name: 'Charmed', preference: 'couple', description: 'A fantasy series about three witch sisters fighting evil.' },
    { name: 'The OC', preference: 'couple', description: 'A teen drama set in affluent Orange County, California.' },
    { name: 'One Tree Hill', preference: 'couple', description: 'A long-running teen drama about love and basketball.' },
    ...
    { name: 'Breaking Bad', preference: 'couple', description: 'A gripping crime drama about a chemistry teacher turned meth kingpin.' }
  ],
  restaurants: [
  ...
  creatives: [
    { name: 'bell hooks', preference: 'couple', description: 'Influential author and feminist cultural critic.' },
    { name: 'Octavia Butler', preference: 'couple', description: 'Pioneering science fiction writer and visionary.' },
    { name: 'Jordan Peele', preference: 'couple', description: 'Acclaimed filmmaker blending horror and social commentary.' },
    { name: 'Frida Kahlo - saw so much of her work in Mexico City 😍', preference: 'couple', description: 'Iconic Mexican painter known for vivid self-portraits.' }
  ],
  music: [
    ...
    { name: 'Tame Impala', preference: 'couple', description: 'Australian psychedelic music project by Kevin Parker.' },
    { name: 'Florence + the Machine', preference: 'couple', description: 'British indie rock band fronted by Florence Welch.' },
    { name: 'Lana Del Ray', preference: 'couple', description: 'Singer-songwriter known for cinematic, melancholic pop.' },
    { name: 'Metric', preference: 'couple', description: 'Canadian indie rock band with electronic influences.' },
    { name: 'The Beatles', preference: 'couple', description: 'Legendary British band that changed popular music.' },
    { name: 'Beyoncé', preference: 'couple', description: 'Superstar singer, songwriter, and cultural icon.' },
    { name: 'Rhianna', preference: 'couple', description: 'Barbadian singer and global pop sensation.' },
    { name: 'Lily Allen', preference: 'couple', description: 'British pop singer-songwriter with witty lyrics.' },
    { name: 'Feist', preference: 'couple', description: 'Canadian indie pop singer-songwriter and guitarist.' },
    { name: 'The Strokes', preference: 'couple', description: 'New York City rock band with garage revival sound.' },
    { name: 'Interpol', preference: 'couple', description: 'Post-punk revival band from New York City.' },
    { name: 'Modest Mouse', preference: 'couple', description: 'Indie rock band known for quirky, introspective lyrics.' },
    { name: 'Death Cab for Cutie', preference: 'couple', description: 'Indie rock band with emotive, melodic sound.' },
    { name: 'The Shins', preference: 'couple', description: 'Indie pop band with catchy, thoughtful songwriting.' },
    { name: 'Franz Ferdinand', preference: 'couple', description: 'Scottish indie rock band with danceable hits.' },
    { name: 'The White Stripes', preference: 'couple', description: 'Garage rock duo known for raw, minimalist sound.' },
    { name: 'The Killers', preference: 'couple', description: 'Las Vegas rock band with anthemic, synth-driven songs.' },
    { name: 'The Decemberists', preference: 'couple', description: 'Indie folk rock band with literary storytelling.' },
    { name: 'My Chemical Romance', preference: 'couple', description: 'Emo rock band with theatrical, emotional style.' },
    { name: 'Fall Out Boy', preference: 'couple', description: 'Pop punk band with catchy, energetic anthems.' },
    { name: 'Panic! at the Disco', preference: 'couple', description: 'Pop rock band known for dramatic, eclectic sound.' },
    { name: 'Paramore', preference: 'couple', description: 'Pop punk band fronted by Hayley Williams.' },
    { name: '30 Seconds to Mars', preference: 'couple', description: 'Alternative rock band led by Jared Leto.' },
    { name: 'Muse', preference: 'couple', description: 'British rock band with grand, futuristic sound.' },
    ...
    { name: 'Gone Gone Beyond', preference: 'couple', description: 'Genre-blending band with soulful, uplifting music.' },
    ...
    { name: 'Led Zeppelin', preference: 'couple', description: 'Iconic British rock band with legendary guitar riffs.' },
    { name: 'AC/DC', preference: 'couple', description: 'Australian hard rock band with electrifying performances.' },
    { name: 'Rolling Stones', preference: 'couple', description: 'Legendary British rock band with decades of hits.' },
    { name: 'YES', preference: 'couple', description: 'Progressive rock band known for complex compositions.' },
    { name: 'Rush', preference: 'couple', description: 'Canadian progressive rock band with virtuosic musicianship.' },
    ...
    { name: 'Phil Oakes', preference: 'couple', description: 'Protest singer-songwriter known for political lyrics.' },
    ...
    { name: 'Mariah Carey (90s)', preference: 'couple', description: 'Pop diva known for her powerful vocal range.' },
    { name: 'Whitney Houston (90s)', preference: 'couple', description: 'Iconic pop and R&B singer with soaring vocals.' },
    ...
    { name: 'Prince', preference: 'couple', description: 'Musical genius blending funk, rock, and pop.' },
    { name: 'Oingo Boingo', preference: 'couple', description: 'New wave band with quirky, energetic sound.' }
  ]
}; 